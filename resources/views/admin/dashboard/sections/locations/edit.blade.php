...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item active">{{$location->name}}</div>
</div>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 mb-4">
                                ...
                                <select name="show_at_home" class="form-control">
                                    <option value="1" @selected(old('show_at_home',$location->show_at_home)==true)>Yes</option>
                                    <option value="0" @selected(old('show_at_home',$location->show_at_home)==false)>No</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6 mb-4">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" @selected(old('status',$location->status)==true)>Active</option>
                                    <option value="0" @selected(old('status',$location->status)==false)>Inactive</option>
                                </select>
                            </div>

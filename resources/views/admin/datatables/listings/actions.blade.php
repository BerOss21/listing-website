<div class="btn-group">
    ...
    <div class="dropdown d-inline">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="{{ route('admin.sections.listings.images.create',$id) }}">Image gallery</a>
            <a class="dropdown-item" href="{{ route('admin.sections.listings.videos.create',$id) }}">Video gallery</a>

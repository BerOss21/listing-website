        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small2.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                        <div class="wsus__category_text">
                            <div class="wsus__category_text_center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small3.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                        <div class="wsus__category_text">
                            <div class="wsus__category_text_center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small5.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                        <div class="wsus__category_text">
                            <div class="wsus__category_text_center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small4.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                        <div class="wsus__category_text">
                            <div class="wsus__category_text_center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <a href="#" class="wsus__category_single">
                        <div class="wsus__category_img">
                            <img src="{{asset('frontend/assets/images/user_small6.jpg')}}" alt="img" class="img-fluid w-100">
                        </div>
                        <div class="wsus__category_text">
                            <div class="wsus__category_text_center">

            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_blog">
                        <div class="img">
                            <img src="{{asset('frontend/assets/images/blog_1.jpg')}}" alt="bloh images" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            ...
                            <a class="read_btn" href="blog_details.html">learn more <i class="far fa-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_blog">
                        <div class="img">
                            <img src="{{asset('frontend/assets/images/blog_2.jpg')}}" alt="bloh images" class="img-fluid w-100">
                        </div>
                        <div class="text">
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_blog">
                        <div class="img">
                            <img src="{{asset('frontend/assets/images/blog_3.jpg')}}" alt="bloh images" class="img-fluid w-100">
                        </div>
                        <div class="text">
                            <span><i class="fal fa-calendar-alt"></i> 05 Julay 2021</span>
                            <span><i class="fas fa-user"></i> by admin</span>

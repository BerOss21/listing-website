            ...
            <div class="amenities_check_area">
                <div class="wsus__pro_check">
                    <div class="form-check">
                        <input class="form-check-input" name="amenities[]" type="checkbox" @checked(in_array($amenity->id,old('amenities') ?? $listing->amenities->pluck('id')->toArray())) value="{{ $amenity->id }}" id="flexCheckIndeterminate">
